...
export const AnalysePage: React.FC = () => {
  ...
  const renderContactForm = () => {
    const inputClasses = "w-full bg-white border-2 border-sand-dark rounded-xl py-4 px-5 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-hostgains focus:border-hostgains transition-all text-lg pl-14";
      ...
      <div className="space-y-6">
        ...
        <label className="flex items-start gap-3 cursor-pointer mt-6">
          ...
          <span className="text-sm text-gray-600 leading-relaxed">
            ...
            <Link to="/datenschutz" className="text-hostgains hover:underline">
