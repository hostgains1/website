  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="bg-white rounded-lg shadow-lg px-4 py-3 max-w-[200px] relative"
      >
        <button
          className="absolute -top-1 -right-1 w-5 h-5 bg-gray-200 hover:bg-gray-300 rounded-full flex items-center justify-center text-gray-500 text-xs transition-colors"
          onClick={(e) => {
            e.stopPropagation();
        ...
        <p className="text-gray-800 text-sm font-medium leading-tight">
          Du hast Fragen? Schreib uns ganz einfach.
        </p>
        {/* Triangle pointer */}
      ...
      <motion.a
        ...
        aria-label="Kontaktiere uns auf WhatsApp"
      >
        {/* Pulse ring animation */}
        <span className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-25" />

        {/* Button */}
        <div className="relative w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 hover:bg-[#20BD5A]">
          {/* WhatsApp Icon */}
          <svg
            viewBox="0 0 24 24"
